...
export const ActionTypes = {
  ...
  UPDATE_IS_DATA_FILTERED: "UPDATE_IS_DATA_FILTERED",
};
...
export const updateIsDataFiltered = (isDataFiltered: boolean) => ({
  type: ActionTypes.UPDATE_IS_DATA_FILTERED,
  payload: isDataFiltered,
})
